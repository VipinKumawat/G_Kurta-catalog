...
function renderProductPricing(product) {
  ...
  let htmlContent = `
    <h3> Available Sizes & Pricing For  <span style="color: ${product.color};text-shadow: 2px 0 #fff;">${product.color}</span> <span style="color: BlueViolet;">${product.type}</span> Kurta:</h3>
    <div class="tabs">
